...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/607d26e8b83b8400165dfecc
...
To start editing your site, you can use the Sanity interface at https://js-d26e8.sanity.studio/.
...
Generated at `2021-04-19T06:45:41.667Z` by Stackbit version `0.3.50`.